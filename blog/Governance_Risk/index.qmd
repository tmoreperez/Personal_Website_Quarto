...
Buffer pools provide insurance that the climate mitigation a project achieves is not reversed after the credits credits are issued. For example, CO~2~ removed from the atmosphere in a reforestation project may be released later should a wildfire destroy part of the project. However, as long as the amount of re-emitted CO~2~ caused by wildfire does not exceed that of the buffer pool, there is still a net removal of CO~2~ from the atmosphere, and climate mitigation is achieved.
